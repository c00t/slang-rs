...
impl From<SlangParameterCategory> for ParameterCategory {
    fn from(category: SlangParameterCategory) -> Self {
        match category {
            ...
            SlangParameterCategory::MetalPayload => ParameterCategory::MetalPayload,
            SlangParameterCategory::Count => unreachable!(),
        }
    }
}
...
impl From<ParameterCategory> for SlangParameterCategory {
    fn from(category: ParameterCategory) -> Self {
        match category {
            ...
            ParameterCategory::MetalPayload => SlangParameterCategory::MetalPayload,
        }
    }
}
...
pub struct IGlobalSessionVtable {
    ...
    pub createCompileRequest:
        unsafe extern "C" fn(*mut c_void, *mut *mut slang_ICompileRequest) -> ResultCode,
    pub addBuiltins:
    ...
    pub checkCompileTargetSupport:
        unsafe extern "C" fn(*mut c_void, target: SlangCompileTarget) -> ResultCode,
    pub checkPassThroughSupport:
        unsafe extern "C" fn(*mut c_void, passThrough: SlangPassThrough) -> ResultCode,
    pub compileStdLib:
        unsafe extern "C" fn(*mut c_void, flags: slang_CompileStdLibFlags) -> ResultCode,
    pub loadStdLib: unsafe extern "C" fn(
        *mut c_void,
        stdLib: *const c_void,
        stdLibSizeInBytes: usize,
    ) -> ResultCode,
    pub saveStdLib: unsafe extern "C" fn(
        *mut c_void,
    ...
    pub setSPIRVCoreGrammar:
        unsafe extern "C" fn(*mut c_void, jsonPath: *const c_char) -> ResultCode,
    ...
    pub getSessionDescDigest: unsafe extern "C" fn(
        *mut c_void,
...
pub struct ISessionVtable {
    ...
    pub loadModule: unsafe extern "C" fn(
        *mut c_void,
        moduleName: *const c_char,
        outDiagnostics: *mut *mut ISlangBlob,
    ) -> *mut slang_IModule,
    pub loadModuleFromSource: unsafe extern "C" fn(
        *mut c_void,
        moduleName: *const c_char,
        path: *const c_char,
    ...
    pub createCompositeComponentType: unsafe extern "C" fn(
        *mut c_void,
    ...
    pub specializeType: unsafe extern "C" fn(
        *mut c_void,
    ...
    pub getTypeLayout: unsafe extern "C" fn(
        *mut c_void,
        type_: *mut slang_TypeReflection,
    ...
    pub getContainerType: unsafe extern "C" fn(
        *mut c_void,
    ...
    pub getTypeRTTIMangledName: unsafe extern "C" fn(
        *mut c_void,
        type_: *mut slang_TypeReflection,
        outNameBlob: *mut *mut ISlangBlob,
    ) -> ResultCode,
    pub getTypeConformanceWitnessMangledName: unsafe extern "C" fn(
        *mut c_void,
        type_: *mut slang_TypeReflection,
        interfaceType: *mut slang_TypeReflection,
        outNameBlob: *mut *mut ISlangBlob,
    ) -> ResultCode,
    pub getTypeConformanceWitnessSequentialID: unsafe extern "C" fn(
        *mut c_void,
        type_: *mut slang_TypeReflection,
        interfaceType: *mut slang_TypeReflection,
        outId: *mut u32,
    ) -> ResultCode,
    pub createCompileRequest: unsafe extern "C" fn(
        *mut c_void,
        outCompileRequest: *mut *mut slang_ICompileRequest,
    ) -> ResultCode,
    pub createTypeConformanceComponentType: unsafe extern "C" fn(
        *mut c_void,
        type_: *mut slang_TypeReflection,
        interfaceType: *mut slang_TypeReflection,
    ...
    pub loadModuleFromIRBlob: unsafe extern "C" fn(
        *mut c_void,
        moduleName: *const c_char,
        path: *const c_char,
        source: *mut ISlangBlob,
    ...
    pub isBinaryModuleUpToDate: unsafe extern "C" fn(
        *mut c_void,
        modulePath: *const c_char,
        binaryModuleBlob: *mut ISlangBlob,
    ) -> bool,
    pub loadModuleFromSourceString: unsafe extern "C" fn(
        *mut c_void,
        moduleName: *const c_char,
        path: *const c_char,
        string: *const c_char,
...
pub struct IComponentTypeVtable {
    ...
    pub getLayout: unsafe extern "C" fn(
        *mut c_void,
        targetIndex: SlangInt,
        outDiagnostics: *mut *mut ISlangBlob,
    ) -> *mut ProgramLayout,
    ...
    pub getResultAsFileSystem: unsafe extern "C" fn(
        *mut c_void,
        entryPointIndex: SlangInt,
        targetIndex: SlangInt,
        outFileSystem: *mut *mut ISlangMutableFileSystem,
    ) -> ResultCode,
    pub getEntryPointHash: unsafe extern "C" fn(
        *mut c_void,
        entryPointIndex: SlangInt,
        targetIndex: SlangInt,
        outHash: *mut *mut ISlangBlob,
    ),
    pub specialize: unsafe extern "C" fn(
        *mut c_void,
        specializationArgs: *const slang_SpecializationArg,
        specializationArgCount: SlangInt,
    ...
    pub renameEntryPoint: unsafe extern "C" fn(
        *mut c_void,
        newName: *const c_char,
        outEntryPoint: *mut *mut slang_IComponentType,
    ) -> ResultCode,
    pub linkWithOptions: unsafe extern "C" fn(
        *mut c_void,
        outLinkedComponentType: *mut *mut slang_IComponentType,
    ...
    pub getTargetCode: unsafe extern "C" fn(
        *mut c_void,
        targetIndex: SlangInt,
        outCode: *mut *mut ISlangBlob,
        outDiagnostics: *mut *mut ISlangBlob,
    ) -> ResultCode,
    pub getTargetMetadata: unsafe extern "C" fn(
        *mut c_void,
        outMetadata: *mut *mut slang_IMetadata,
        outDiagnostics: *mut *mut ISlangBlob,
    ) -> ResultCode,
    pub getEntryPointMetadata: unsafe extern "C" fn(
        *mut c_void,
        targetIndex: SlangInt,
        outMetadata: *mut *mut slang_IMetadata,
        outDiagnostics: *mut *mut ISlangBlob,
...
pub struct IModuleVtable {
    ...
    pub findEntryPointByName: unsafe extern "C" fn(
        *mut c_void,
        name: *const c_char,
        outEntryPoint: *mut *mut slang_IEntryPoint,
    ) -> ResultCode,
    pub getDefinedEntryPointCount: unsafe extern "C" fn(*mut c_void) -> SlangInt32,
    pub getDefinedEntryPoint: unsafe extern "C" fn(
        *mut c_void,
        index: SlangInt32,
        outEntryPoint: *mut *mut slang_IEntryPoint,
    ) -> ResultCode,
    pub serialize:
        unsafe extern "C" fn(*mut c_void, outSerializedBlob: *mut *mut ISlangBlob) -> ResultCode,
    pub writeToFile: unsafe extern "C" fn(*mut c_void, fileName: *const c_char) -> ResultCode,
    ...
    pub findAndCheckEntryPoint: unsafe extern "C" fn(
        *mut c_void,
        name: *const c_char,
        stage: SlangStage,
        outEntryPoint: *mut *mut slang_IEntryPoint,
    ...
    pub getDependencyFilePath:
        unsafe extern "C" fn(*mut c_void, index: SlangInt32) -> *const c_char,
